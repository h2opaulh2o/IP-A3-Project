...
public class BingBangSearch {
	public static String[][] rezultate;
    ...
    public static String[][] search (String x,String z)throws SAXException, IOException, ParserConfigurationException {
                String[][] rezultate=new String[300][3];
		// this is the phrase
		String phrase = x;
		...
		{  
                    ...
                    rezultate[y][0]=lastResults.get(g).getData().getTitle();
                    rezultate[y][1]=lastResults.get(g).getData().getUrl();
                    rezultate[y][2]=String.valueOf(lastResults.get(g).getFrequency());
