...
public class JFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        InternalFrame.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        InternalFrame.setBounds(530, 280, 700, 350);
        ...
        newsButton.setBounds(540, 200, 90, 70);

        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkginterface/res/lupa.png"))); // NOI18N
        ...
        jButton2.setBounds(530, 200, 110, 80);
        ...
        englishButton.setBounds(250, 600, 100, 30);
        ...
        romanaButton.setBounds(350, 600, 100, 30);
        ...
        jTextField4.setBounds(80, 600, 110, 30);
        ...
        getNews.setBounds(290, 370, 100, 30);
        ...
        colorMixer.setBounds(290, 270, 100, 30);
        ...
        jTextField1.setBounds(80, 220, 110, 30);
        ...
        jTextField2.setBounds(80, 320, 110, 30);
        ...
        jTextField3.setBounds(80, 270, 110, 30);
        ...
        searchEngineSelector.setBounds(290, 220, 100, 30);
        ...
        jTextField5.setBounds(80, 460, 90, 30);

        jTextField6.setText("RSS Url");
        getContentPane().add(jTextField6);
        jTextField6.setBounds(80, 510, 190, 30);

        jButton1.setBackground(new java.awt.Color(255, 204, 102));
        jButton1.setText("SetRSS");
        ...
        jButton1.setBounds(290, 510, 100, 30);
        ...
        backOpt.setMaximumSize(new java.awt.Dimension(4000, 700));
        backOpt.setMinimumSize(new java.awt.Dimension(4000, 700));
        backOpt.setPreferredSize(new java.awt.Dimension(4000, 300));
        getContentPane().add(backOpt);
        backOpt.setBounds(40, 150, 440, 500);
        ...
        back.setMaximumSize(new java.awt.Dimension(4000, 600));
        back.setMinimumSize(new java.awt.Dimension(4000, 600));
        back.setPreferredSize(new java.awt.Dimension(4000, 600));
        getContentPane().add(back);
        back.setBounds(510, 200, 740, 450);
        ...
        searchButton.setBounds(1200, 150, 50, 40);
        ...
        searchBar.setBounds(510, 150, 740, 40);
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        { 
            if (results[i][1]!=null && results[i][1].matches("http.*")) {
                if (results[i][0]!=null && results[i][0].length()>1)
                builder.append("<li><a href="+results[i][1]+">"+results[i][0]+"</a><font color='red'> "+results[i][2]+"</font></li><br>");       
            }
            else
            {
             if (results[i][1]!=null && results[i][1].length()>1)
                builder.append("<li><a href="+results[i][0]+">"+results[i][1]+"</a><font color='red'> "+results[i][2]+"</font></li><br>");
            }
    ...
    private void colorMixerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_colorMixerActionPerformed
         JComboBox comboBox = (JComboBox) evt.getSource();
                ...
                {background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkginterface/res/white.jpg")));
                ...
                {background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkginterface/res/red.jpg")));
                ...
                jTextField4.setBackground(myColor3);}
                  ...
                  {background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkginterface/res/bkg.jpg")));
                ...
                {background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkginterface/res/blue.jpg")));
                ...
                {background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkginterface/res/green.jpg")));
                    searchBar.setBackground(Color.white);
                ...
                {background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkginterface/res/yellow.jpg")));
                    searchBar.setBackground(Color.white);
    ...
    private void romanaButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_romanaButtonActionPerformed
       ...
       Options.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkginterface/res/Optiuni.png")));
       jTextField5.setText("Titlu");
    ...
    private void englishButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_englishButtonActionPerformed
       ...
       getNews.setText("GetNews");
       jButton1.setText("SetRSS");
       Options.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkginterface/res/Options.png")));
       colorMixer.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Default", "White", "Red", "Yellow", "Blue", "Green" }));
       jTextField5.setText("Title");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
       Site1.setText(jTextField5.getText());
        Site1.setName(jTextField6.getText());
    ...
    private javax.swing.JLabel Site1;
